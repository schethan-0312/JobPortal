...
export default function Navbar7() {
  ...
  const notificationListContent = (
    <>
      ...
      <div className="ntf-list-groups">
        ...
        <div className="ntf-list-groups-single">
          <Link href="/candidate-dashboard" className="ntf-more" onClick={() => setShowNotifications(false)}>
  ...
  const accountMenuContent = (
    <>
      ...
      <ul>
        <li>
          <Link href="/candidate-dashboard" onClick={() => setShowAccountMenu(false)}>
            <i className="fa fa-tachometer-alt"></i>Dashboard
          </Link>
        </li>
        <li>
          <Link href="/candidate-profile" onClick={() => setShowAccountMenu(false)}>
            <i className="fa fa-user-tie"></i>My Profile
          </Link>
        </li>
        <li>
          <Link href="/candidate-resume" onClick={() => setShowAccountMenu(false)}>
            <i className="fa fa-file"></i>My Resume
          </Link>
        </li>
        <li>
          <Link href="/candidate-saved-jobs" onClick={() => setShowAccountMenu(false)}>
            <i className="fa-solid fa-bookmark"></i>Saved Resume
          </Link>
        </li>
        <li>
          <Link href="/candidate-messages" onClick={() => setShowAccountMenu(false)}>
            <i className="fa fa-envelope"></i>Messages
            {unreadMessages > 0 && <span className="notti_coun style-3">{unreadMessages}</span>}
          </Link>
        </li>
        <li>
          <Link href="/candidate-delete-account" onClick={() => setShowAccountMenu(false)}>
